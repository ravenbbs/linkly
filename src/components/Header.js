        ...
        <div className="navbar-end">
          {!!session && (
            <>
              ...
              tabIndex={0}
              role="button"
              className="rounded-box btn-ghost flex items-center mx-2	py-1 px-2 cursor-pointer"
            >
              <h2 className="font-bold text-center mr-2 max-sm:hidden">{session.user?.name}</h2>
          ...
          {!session && (
            <>
              <Link href={"/login"} className="btn btn-primary mx-2">
                Ingresa
              </Link>
